package cn.kotlincloud.user.front.tool;
...
public class FrontGenerator {
    public static void main(String[] args) throws Exception {
        ...
        String modelPackage = "cn.kotlincloud.user.front.entity"; //设置model的包名
        ...
        //设置service层的包名
        String servicePackage = "cn.kotlincloud.user.front.services";
